...
async def callback(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # Выбор дома -> показываем ПОДЪЕЗДЫ
    ...
    # Выбор подъезда -> показываем КВАРТИРЫ
    ...
    # Выбор квартиры -> ФИНАЛЬНОЕ БРОНИРОВАНИЕ
